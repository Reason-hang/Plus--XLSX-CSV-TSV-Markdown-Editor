...
- 证据：当前 package.json 版本为 1.9.98-local.2；src/shared/markdownThemeService.ts 已包含外置 CSS 加载、路径校验、manifest 提示、监听和失败回退；远端 personal/main 与当前基线提交一致。
