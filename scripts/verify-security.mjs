...
assert.match(mdProviderSource, /resolveMarkdownImageTarget/);
assert.match(mdProviderSource, /imageExtension/);
...
assert.match(mdWebviewSource, /parseLinkDestination/);
assert.match(mdWebviewSource, /vscode-cdn\.net/);
